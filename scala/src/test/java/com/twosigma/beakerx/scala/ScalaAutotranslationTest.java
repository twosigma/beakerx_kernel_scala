...
import com.twosigma.beakerx.AutotranslationServiceTestMock;
...
public class ScalaAutotranslationTest extends KernelSetUpFixtureTest {
  ...
  private AutotranslationServiceTestMock autotranslationService;

  public ScalaAutotranslationTest() {
  ...
  protected Kernel createKernel(String sessionId, KernelSocketsFactory kernelSocketsFactory, CloseKernelAction closeKernelAction) {
    autotranslationService = new AutotranslationServiceTestMock();
