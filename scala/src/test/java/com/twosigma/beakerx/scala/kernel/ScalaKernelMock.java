...
public class ScalaKernelMock extends KernelTest {
  ...
  public ScalaKernelMock(String id) {
    super(id, new BeakerXCommRepositoryMock(), MessageCreator.get(), new MagicCommandConfigurationMock());
  }

  public ScalaKernelMock(String id, Evaluator evaluator) {
    super(id, evaluator, MessageCreator.get(), new MagicCommandConfigurationMock());
  }
