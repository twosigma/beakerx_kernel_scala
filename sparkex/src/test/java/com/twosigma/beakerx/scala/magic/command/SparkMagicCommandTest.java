...
import com.twosigma.beakerx.SparkexKernelTestFactory;
...
public class SparkMagicCommandTest {
  ...
  public void setUp() {
    ...
    kernel = SparkexKernelTestFactory.getKernel();
  ...
  private MagicCommandOutcomeItem connectToSparkSecondTime() {
    Code code2 = Code.createCode("", new ArrayList<>(), new ArrayList<>(), commMsg(), MessageCreator.get(), new SimpleEvaluationObjectFactory());
  ...
  private MagicCommandOutcomeItem createSparkUiAndConnectToSession() {
    Code code = Code.createCode("%%spark", new ArrayList<>(), new ArrayList<>(), commMsg(), MessageCreator.get(), new SimpleEvaluationObjectFactory());
