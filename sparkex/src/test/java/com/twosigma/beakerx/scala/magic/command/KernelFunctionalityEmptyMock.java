...
public class KernelFunctionalityEmptyMock implements KernelFunctionality {
  ...
  private ExecutionResultSender executionResultSender = new ExecutionResultSender(this, MessageCreator.get());
  ...
  @Override
  public TryResult executeCode(String code, EvaluationObject seo) {
    return TryResult.createResult(code);
  }

  @Override
  public TryResult executeCode(String code, EvaluationObject seo, ExecutionOptions executionOptions) {
    return null;
  }
